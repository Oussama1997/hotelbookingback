...
public interface RoomService {
    ...
    ApiResponse<RoomDTO> updateRoom(String roomNumber, RoomRequestDTO roomRequest, MultipartFile[] newImages, List<String> imagesToDelete);
    ...
    ApiResponse<RoomDTO> getRoomByNumber(String roomNumber);
    ApiResponse<RoomDTO> deleteRoom(String roomNumber);
